...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#"><img src="assets/imagens/lola.png" alt="" width="120px"></a>
...
<header class="jumbotron my-4 home-banner">
    <div class="container">
        <h1 class="display-3">Outlet das Princesas</h1>
...
<div class="container">
    ...
    <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    <a href="app/views/produto.php?codigo=<?= $prod->codigo ?>"><img class="card-img-top" src="assets/imagens/<?=$prod->imagem?>" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title"><?= $prod->nome ?></h4>
                        <p class="card-text"><?= $prod->verificarDisponibilidade() ?></p>
                        <p class="card-text"><?= 'R$'.$prod->preco ?></p>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque.</p>
                    </div>
                    <div class="card-footer">
                        <a href="app/views/produto.php?codigo=<?= $prod->codigo ?>" class="btn btn-ifc" style="">Comprar</a>
                    </div>
                </div>
            </div>
